package com.momsmeals.utilities;
...
// We are hiding this driver from outside the class.
// Static because we don't want to create an object. I want to use this method calling class name. It is done through just call the class name.

// it will check driver is null. And for the first time it will be null because we didin't set up driver. so we will set up driver inside of if statement.